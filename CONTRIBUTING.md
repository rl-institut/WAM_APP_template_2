...
- Setup of WAM server [repository](https://github.com/rl-institut/WAM/blob/master/CONTRIBUTING.md)

#### Step 1: Clone the current repository within the WAM server repository and install its dependencies

```bash
git clone https://github.com/rl-institut/WAM_APP_template_2.git
```
